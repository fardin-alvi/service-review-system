                ...
                <div className="border-2 rounded-lg p-5 w-full mx-w-lg ">
                    ...
                    <form onSubmit={handleAddReview} className='space-y-2'>
                        <div>
                            ...
                            <textarea name="review" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-purple-500 focus:border-purple-500 dark:text-black" placeholder="Description"
                            ></textarea>
                        </div>
